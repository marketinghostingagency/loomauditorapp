      ...
      {parsed.map((section: any, idx: number) => {
        ...
        return (
          <div key={idx} className="border border-[#464646] rounded-xl overflow-hidden bg-black/40 transition-all shadow-sm shadow-[#f5ed38]/5">
            ...
            >
              <div 
                className="p-6 pt-0 text-slate-200 text-lg leading-relaxed font-medium whitespace-pre-line border-t border-[#464646]/50 prose prose-invert max-w-none prose-p:mb-5 prose-p:leading-relaxed prose-ul:my-4 prose-li:mb-2 prose-strong:text-[#f5ed38]"
