        ...
        {(audit.brandName || audit.apexDomain) && (
          <div className="glass-card rounded-2xl p-6 flex flex-col gap-4 border border-[#464646] mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              ...
              {/* Sitemap */}
              {audit.sitemapXml && (
                <a href={`data:text/csv;base64,${audit.sitemapXml}`} download={`seo-meta-${audit.brandName}.csv`} className="bg-[#222] hover:bg-[#333] text-blue-400 font-medium py-2 px-4 rounded-lg flex items-center justify-center transition-colors border border-blue-500/30">
