  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2 pt-2">
         <p className="text-xs text-slate-500 text-center font-mono uppercase">Local Developer Fallback</p>
         <button
          onClick={() => signIn('credentials', { password: 'devmode123', callbackUrl: '/admin/dashboard' })}
          className="w-full bg-[#111] hover:bg-[#222] text-[#f5ed38] font-bold py-3 px-4 rounded-xl transition-colors border border-[#464646]"
         >
